...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_path", type=str, default="../remote/configs/mistral7B.json")
    ...
    # 定义一个Agent
    mistral = MistralLLM(args.config_path)
    ...
    QA1_agent = QA1Agent(logger, mistral, language=language,
    ...
    prompt, res = QA1_agent.get_answer(cn_data1)
